...
const Login = () => {
  ...
  return (
    <div
      className="min-h-screen w-full sm:min-h-[90vh] sm:w-[95vw] bg-[#004355] bg-cover bg-center bg-no-repeat sm:bg-fixed sm:rounded-2xl flex flex-col justify-center p-4 sm:p-6 overflow-hidden"
