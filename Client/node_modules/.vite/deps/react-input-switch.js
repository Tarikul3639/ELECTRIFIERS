...
var render = function render2(cache, props, theme, ref) {
  ...
  var serialized = serializeStyles3(registeredStyles);
  if (serialized.name.indexOf("-") === -1) {
    var labelFromStack = props[labelPropName];
    if (labelFromStack) {
      serialized = serializeStyles3([serialized, "label:" + labelFromStack + ";"]);
    }
  }
...
var Global = withEmotionCache(function(props, cache) {
  ...
  if (typeof styles === "function") {
    return (0, import_react2.createElement)(ThemeContext.Consumer, null, function(theme) {
      var serialized2 = serializeStyles3([styles(theme)]);
  ...
  var serialized = serializeStyles3([styles]);
  return (0, import_react2.createElement)(InnerGlobal, {
    serialized,
    cache
  });
...
var ClassNames = withEmotionCache(function(props, context) {
  return (0, import_react2.createElement)(ThemeContext.Consumer, null, function(theme) {
    ...
    var css2 = function css3() {
      ...
      var serialized = serializeStyles3(args, context.registered);
      {
...
// node_modules/react-input-switch/dist/index.esm.js
var makeStyles = function makeStyles2(customStyles) {
  return {
...
var Switch = function Switch2(_ref) {
  var customStyles = _ref.styles, on = _ref.on, off = _ref.off, value = _ref.value, onChange = _ref.onChange, name = _ref.name, disabled = _ref.disabled, props = _objectWithoutPropertiesLoose(_ref, ["styles", "on", "off", "value", "onChange", "name", "disabled"]);
  ...
  return jsx("label", _extends({}, props, {
    css: css_browser_esm_default([styles.container, disabled && styles.containerDisabled]),
    ...
    css: css_browser_esm_default([styles.track, checked && styles.trackChecked])
  }), jsx("span", {
    css: css_browser_esm_default([styles.button, checked && styles.buttonChecked])
  }));
};
Switch.defaultProps = {
  value: 1,
...
var index_esm_default = Switch;
export {
  index_esm_default as default
};
//# sourceMappingURL=react-input-switch.js.map
